...
Tavily, Brave, Kagi, Exa AI, GitHub, Linkup, Firecrawl, and Keenable
...
Tavily, Kagi, Firecrawl, Exa, or Keenable.
...
- `FIRECRAWL_API_KEY`
- `KEENABLE_API_KEY`
- `KEENABLE_ALLOW_PUBLIC` optional, set `1` to opt into the shared
  public tier
