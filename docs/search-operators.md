...
| Feature                               | Brave                                   | Kagi                                   | Tavily                                         | Exa                              | TinyFish                     | GitHub                                  |
| ------------------------------------- | --------------------------------------- | -------------------------------------- | ---------------------------------------------- | -------------------------------- | ---------------------------- | --------------------------------------- |
...
| `include_domains` / `exclude_domains` | Merged into query as `site:` / `-site:` | Merged/preserved as provider filtering | Native request fields                          | Native request fields            | Native query params          | Not applicable                          |
...
| `loc:us` / `location:us`              | Native query passthrough                | Query passthrough                      | `country` parameter                            | Not a primary operator           | `location`                   | Not applicable                          |
| `before:` / `after:`                  | Native query passthrough                | Kagi `time_range` parameter            | `end_date` / `start_date`                      | Not a primary operator           | `before_date` / `after_date` | GitHub supports its own date qualifiers |
