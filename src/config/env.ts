...
export const QUERIT_API_KEY = process.env.QUERIT_API_KEY;
...
export const validate_config = () => {
	...
	if (!QUERIT_API_KEY) missing_keys.push('QUERIT_API_KEY');
	else available_keys.push('QUERIT_API_KEY');
